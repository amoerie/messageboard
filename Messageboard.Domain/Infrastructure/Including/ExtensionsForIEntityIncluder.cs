...
namespace Messageboard.Domain.Infrastructure.Including
{
    public static class ExtensionsForIEntityIncluder
    {
        ...
        public static IEntityIncluder<TEntity> Include<TEntity, TProperty>(this IEntityIncluder<TEntity> includer, Expression<Func<TEntity, TProperty>> property) where TEntity : class
        {
